  ...
  return (
    <>
      ...
      <div className="po-container">
        <h1 className="po-head">Terms of service</h1>
        <p className="po-para">
          These terms and conditions outline the rules and regulations for the
          use of TINTED's Website, located at tinted.in
        </p>
        <p className="po-para">
          {" "}
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use tinted.in if you do not agree to
        ...
        <h2>Your Privacy</h2>
        <p className="po-para">Please read Privacy Policy</p>
        <p className="po-para">
